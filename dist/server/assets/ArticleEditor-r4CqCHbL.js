import { a2 as getDefaultExportFromCjs, r as reactExports, U as React, V as jsxRuntimeExports } from "./server-Crqfv4f8.js";
import { l as useNavigate, u as useQueryClient } from "./router-Dv_1nnSX.js";
...
function ImageDropzone({ onUploaded, children }) {
...
`);
        setFiles(
          (prev) => prev.map(
            (f) => f.id === id ? { ...f, progress: "done", url: sas.public_url } : f
          )
        );
        setTimeout(
        ...
        setFiles(
          (prev) => prev.map(
            (f) => f.id === id ? { ...f, progress: "error", error: err.message || "Upload failed" } : f
          )
        );
      }
    },
  ...
  const onDrop = reactExports.useCallback(
    (accepted) => accepted.forEach(upload),
    [upload]
  );
  const { getRootProps, getInputProps, isDragActive, open } = useDropzone({
    ...
    maxSize: MAX_BYTES,
    noClick: true,
    // we provide our own click target via `open()`
    noKeyboard: true
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ...getRootProps(), className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...getInputProps() }),
    isDragActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-20 border-2 border-dashed border-primary bg-primary/5 backdrop-blur-sm flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { size: 32, className: "mx-auto mb-3 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg", children: "Drop image to upload" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground mt-2", children: "JPEG, PNG, WebP, GIF · max 10 MB" })
    ] }) }),
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center justify-between gap-3 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-muted-foreground", children: "Or drag & drop into the editor (max 10 MB)" })
    ] }),
    files.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 space-y-2", children: files.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: f.progress === "done" ? "text-primary" : f.progress === "error" ? "text-destructive" : "text-muted-foreground",
              children: f.progress === "done" ? "✓" : f.progress === "error" ? "✗" : "↑"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate flex-1", children: f.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-[10px] uppercase tracking-[0.18em]", children: f.progress === "uploading" ? "Uploading…" : f.progress === "done" ? "Inserted" : f.error || "Failed" }),
          f.progress !== "uploading" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function ArticleEditor({ mode }) {
  ...
  const [body, setBody] = reactExports.useState(initial.body_md);
  const [publish, setPublish] = reactExports.useState(initial.publish);
...
`);
  ...
  const onTitleChange = (v) => {
    ...
    if (mode.kind === "create" && !slug) {
      const auto = v.toLowerCase().trim().replace(/[^a-z0-9\s-]/g, "").replace(/\s+/g, "-").replace(/-+/g, "-").slice(0, 80);
      setSlug(auto);
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-4 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground", children: mode.kind === "create" ? "New Article" : "Editing" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl md:text-4xl font-extrabold tracking-tighter mt-2 truncate max-w-2xl", children: title || "Untitled" })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              save.isPending ? "Saving…" : publish ? "Save & publish" : "Save draft"
            ]
          }
        )
      ] })
    ] }),
    save.isError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 border border-destructive/30 bg-destructive/5 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm text-destructive", children: save.error.message }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-8 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            label: "Slug",
            hint: mode.kind === "edit" ? "Slug is immutable after creation." : "URL: /stories/<slug>",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: showPreview ? "Preview" : "Body (Markdown)", children: showPreview ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "prose-article min-h-[400px] border border-border p-6 bg-card",
            dangerouslySetInnerHTML: { __html: g.parse(body) }
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ImageDropzone, { onUploaded: (md) => insertAtCursor(md), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ref: bodyRef,
            value: body,
...
[Link](https://example.com)`
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "lg:col-span-4 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border p-6 bg-card space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground", children: "Visibility" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-start gap-3 cursor-pointer", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-sm", children: "Publish" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: "Makes the article visible on /stories. Uncheck to keep as a draft." })
            ] })
          ] })
        ] }),
        mode.kind === "edit" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border p-6 bg-card space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground", children: "Metadata" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "space-y-2 font-mono text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: "Created", v: new Date(mode.article.created_at).toLocaleString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: "Updated", v: new Date(mode.article.updated_at).toLocaleString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Row,
              {
                k: "Published",
                v: mode.article.published_at ? new Date(mode.article.published_at).toLocaleString() : "—"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: "Source lang", v: mode.article.source_lang })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border p-6 bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground mb-3", children: "Markdown tips" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "font-mono text-xs space-y-1.5 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "# Heading" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "## Subheading" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "**bold** · *italic*" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "[link](https://...)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "- bullet list" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "> blockquote" })
          ] })
        ] })
      ] })
    ] })
...
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground mb-2 block", children: label }),
    children,
    hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: hint })
  ] });
}
function Row({ k, v }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-muted-foreground uppercase text-[10px] tracking-[0.15em]", children: k }),
