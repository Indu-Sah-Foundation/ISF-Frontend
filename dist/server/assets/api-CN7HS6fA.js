import { S as Subscribable, p as pendingThenable, r as resolveQueryBoolean, s as shallowEqualObjects, c as resolveStaleTime, a as noop, e as environmentManager, i as isValidTimeout, t as timeUntilStale, d as timeoutManager, f as focusManager, j as fetchState, k as replaceData, n as notifyManager, b as shouldThrowError, u as useQueryClient } from "./router-Dff4uBNA.js";
import { r as reactExports } from "./server-cqlUrkpC.js";
...
const api = {
  ...
  getArticle: (slug, lang) => req(`/articles/${encodeURIComponent(slug)}${lang ? `?lang=${lang}` : ""}`),
