import { V as jsxRuntimeExports, a1 as notFound } from "./server-cqlUrkpC.js";
import { R as Route, L as Link } from "./router-Dff4uBNA.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SiteShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "px-6 pt-16 pb-24 max-w-3xl mx-auto", children: [
    ...
    data && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mt-10 mb-12 border-b border-border pb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[11px] uppercase tracking-[0.2em] text-primary", children: data.published_at ? new Date(data.published_at).toLocaleDateString("en-US", {
          year: "numeric",
          month: "long",
          day: "numeric"
        }) : "Draft" }),
