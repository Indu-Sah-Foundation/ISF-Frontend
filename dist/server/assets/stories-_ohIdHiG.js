...
function StoriesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-6 pt-16 pb-12 max-w-7xl mx-auto border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-primary text-xs uppercase tracking-[0.2em]", children: "Letters from the Foundation" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-6 max-w-7xl mx-auto py-12", children: [
      ...
      data && data.items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16", children: data.items.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/stories/$slug", params: {
        slug: a.slug
      }, className: "group block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-ink pt-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-3xl font-extrabold tracking-tight mt-4 mb-3 group-hover:text-primary transition-colors text-balance", children: a.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] uppercase tracking-[0.18em] text-primary", children: "Read story →" })
      ] }) }, a.id)) })
    ] })
  ] });
}
